...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _jquery_fake__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jquery.fake */ \"./src/jquery.fake.js\");\n/* harmony import */ var _net_request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./net-request */ \"./src/net-request.js\");\n/* harmony import */ var _css_login_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./css/login.css */ \"./src/css/login.css\");\n\n\n\n(0,_jquery_fake__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"#tick\").clicker(function () {\n  return (0,_jquery_fake__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"#tick\").toggle(\"tick2\");\n});\n(0,_jquery_fake__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"a\")[1].clicker(function () {\n  _net_request__WEBPACK_IMPORTED_MODULE_1__.ne.request((0,_net_request__WEBPACK_IMPORTED_MODULE_1__.addCommand)(_net_request__WEBPACK_IMPORTED_MODULE_1__.ports.qr_key, {\n    timestamp: Date.now()\n  })).then(function (json) {\n    var qrCode = (0,_net_request__WEBPACK_IMPORTED_MODULE_1__.addCommand)(_net_request__WEBPACK_IMPORTED_MODULE_1__.ports.qr_create, {\n      key: json.data.unikey,\n      qrimg: true,\n      timestamp: Date.now()\n    });\n    _net_request__WEBPACK_IMPORTED_MODULE_1__.ne.request(qrCode).then(function (qrJson) {\n      var qr = (0,_jquery_fake__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"<img>\").addClass(\"qr-code\").attr(\"src\", qrJson.data.qrimg);\n      (0,_jquery_fake__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"#mylogin>*:not(svg)\").hide();\n      (0,_jquery_fake__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"#mylogin\").apd(qr).plus(\"<div>使用网易云app扫码登录</div>\");\n    });\n    return json;\n  }).then(function (json) {\n    var time1 = Date.now();\n    var loop = setInterval(function () {\n      _net_request__WEBPACK_IMPORTED_MODULE_1__.ne.request((0,_net_request__WEBPACK_IMPORTED_MODULE_1__.addCommand)(_net_request__WEBPACK_IMPORTED_MODULE_1__.ports.qr_check, {\n        key: json.data.unikey,\n        noCookie: true,\n        timestamp: Date.now()\n      })).then(function (resMsg) {\n        var time2 = Date.now();\n        if ((resMsg.code === 803 || resMsg.code === 502) && time2 - time1 <= 300000) {\n          location.href = \"./homepage.html\";\n          clearInterval(loop);\n        }\n      }).catch(function () {\n        return clearInterval(loop);\n      });\n    }, 1000);\n  });\n});\n\n//# sourceURL=webpack:///./src/login.js?");
